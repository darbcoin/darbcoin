...
uint256 hashGenesisBlock("0x1b0e1d05357fb414220db234590cc7adf7216939267d4be8fb843bbab7cee2e8");
...
const string strMessageMagic = "Darbcoin Signed Message:\n";
...
{
    int64 nSubsidy = 3553 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Darbcoin: 1 days
static const int64 nTargetSpacing = 60; // Darbcoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal darbcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Darbcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xad5394dfff14e1ef0487fb8c4645d207b5b22ed1b497982a8d615dcd8ae2394e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Fidelis et gratus";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388080845; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3118665;

        if (fTestNet)
        {
            block.nTime    = 1388080844;
            block.nNonce   = 2350604;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x19f9ac3cde1922b955ff42a20e5bf6beeb88bcd98c9a6ee428cee4ef088b572b"));
